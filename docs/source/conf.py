# -*- coding: utf-8 -*-
#
# pyunsplash documentation build configuration file, created by
...
copyright = u'2016,2017,2018 Salvatore Ventura'
...
#
# html_title = u'pyunsplash v0.1.0'
...
htmlhelp_basename = 'pyunsplashdoc'
...
man_pages = [
    (master_doc, 'pyunsplash', u'pyunsplash Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyunsplash', u'pyunsplash Documentation',
     author, 'pyunsplash', 'One line description of project.',
     'Miscellaneous'),
]
